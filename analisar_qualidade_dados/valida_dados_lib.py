...
DIR_INCONSISTENCIAS = f'{diretorio_principal}/analisar_qualidade_dados/inconsistencias'
...
def valida_subdependencia(df_colunas, base_info):
    """
        ...
        Caso o valor da coluna "dependencia_adm" seja "Artigo 240 - Sistema S"
        ou "Militar" deve estar preenchida a coluna subdependencia, caso o valor
        da coluna "dependencia_adm" seja "Pública" ou "Privada" a coluna subdependencia
    ...
    for linha in tqdm(df_dict):
        codUni = str(linha['codigo_universal_linha'])
        dependencia_admin = linha['dependencia_adm']
    ...
    for coluna in df_colunas.columns:
        if coluna != 'codigo_universal_linha' and (coluna in ['co_ies', 'co_endereco_e_mec']):
            ...
            for linha in tqdm(df_dict):
                ...
                dependencia_admin = str(linha['dependencia_adm'])
                valor = linha[coluna]
